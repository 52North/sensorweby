...
i18n.en_GB={main:{favoritesList:"Favourites"},settings:{permalink:{favorite:"Status as favourite entry"}},guide:{step13:{header:"Favourite management",text:"The legend entries/timeseries could be saved as favourites. In this view all favourites are listed and could be maintained."}},favorite:{edit:{header:"Edit favourite"},group:{add:"The status '{0}' is added to the favourite list."},single:{add:"A new favourite '{0}' is added to the list.",remove:"The favourite '{0}' is removed.",exists:"This favourite still exists.",
notSupported:"The provider of the favourite '{0}' isn't supported and can't be loaded."}}};
i18n.de={fullName:"Deutsch",ok:"OK",main:{legend:"Legende",diagram:"Diagramm",mapView:"Kartenansicht",settings:"Einstellungen",stationSelection:"Wähle eine Station aus",chartView:"Diagrammansicht",allPhenomena:"Alle Phänomene",phenomenon:"Phänomen",favoritesList:"Favoriten",importFavorites:"Importieren",exportFavorites:"Exportieren",importExportHelp:"Datei für den Im- oder Exportieren wählen",noFileSelected:"Keine Datei ausgewählt"},table:{time:"Zeit"},chart:{noTimeseriesSelected:"Sie haben keine Zeitreihe ausgewählt oder die gewählten Zeitreihen haben keine Werte in dem derzeitigen Zeitraum.",
outsideOfDataRange:"Außerhalb des Datenbereichs!",annotation:"Daten ohne Gewähr!"},map:{userLocation:"Hier ist ihr Standort",stationSelection:{station:"Station",selectAllTimeseries:"wähle alle Zeitreihen"},stationLocation:{station:"Station",timeseries:"Zeitreihe",provider:"Datenanbieter"},providerList:{provider:"Datenanbieter",stations:"Stationen",timeseries:"Zeitreihen",phenomena:"Phänomene"},search:{label:"suche Addresse ...",noResult:"Sorry, es konnte keine Adresse gefunden werden."}},listSelection:{header:"Listenbasierte Zeitreihenauswahl",
headers:{category:"Kategorie",station:"Station",phenomenon:"Phänomen",procedure:"Sensor"},warning:{moreThanOneTimeseries:"Mehr als eine Zeitreihe gefunden"}},legend:{entry:{noData:"keine Daten verfügbar",jumpToLastValue:"Springe zur letzten Messung",firstValueAt:"Erster Wert bei",lastValueAt:"Letzter Wert bei"}},"export":{label:"Daten als CSV-File"},timeSelection:{header:"Zeitraum",presetsHeader:"Vordefiniert",presets:{lastHour:"letzte Stunde",today:"heute",yesterday:"gestern",todayYesterday:"heute \x26 gestern",
thisWeek:"diese Woche",lastWeek:"letzte Woche",thisMonth:"diesen Monat",lastMonth:"letzten Monat",thisYear:"dieses Jahr",lastYear:"letztes Jahr"},custom:{header:"Freidefiniert",start:"Startzeitpunkt",end:"Endzeitpunkt"},warning:{startBeforeEnd:"Der Startzeitpunkt darf nicht größer als der Endzeitpunkt sein",maxTimeRange:"Der ausgewählte Zeitraum darf nicht größer als ein Jahr sein"}},styleChange:{header:"Ändern der Zeitreihengestaltung",currentColor:"Derzeitige Farbe",selectColor:"Wähle neue Farbe",
selectBarInterval:"Wähle Balkeninterval",barChartInterval:{hour:"Stunde",day:"Tag",week:"Woche",month:"Monat"},zeroScaled:"Nullbasierte Y-Achse",groupedAxis:"gruppierte Achse"},settings:{header:"Einstellungen",resetStatus:"Lösche den Status",chooseLanguage:"Sprache wechseln",requiresRestart:"Erfordert Neustart!",permalink:{create:"Erstelle Permalink",inWindow:"öffnen im neuen Fenster",inMail:"öffnen in leerer Mail",inClipboard:"Link in die Zwischenablage",clipboardInfo:"Kopiere in die Zwischenablage: Ctrl+C, Enter",
inQrCode:"als QR-Code",favorite:"Status in die Favoritenliste übernehmen"},clusterMarker:"Marker gruppieren",markerWithLastInfo:{header:"Marker mit Wert der letzten Messung",label:"Achtung - dies kann bei einigen Providern zu langen Afragen führen"},saveStatus:"Status mitzeichnen",generalizeData:"Daten generalisiert abfragen",imprint:{header:"Impressum",github:'Zur \x3ca href\x3d"https://github.com/52North/js-sensorweb-client" target\x3d"_blank"\x3eGitHub\x3c/a\x3e-Seite dieses Projekts',text:'\x3cp\x3e\x3ca href\x3d"http://52north.org" target\x3d"_blank"\x3e52\x26deg;North GmbH\x3c/a\x3e ist für diese Website verantwortlich.\x3c/p\x3e\x3cp\x3e52\x26deg;North Initiative for Geospatial Open Source Software GmbH\x3cbr\x3eMartin-Luther-King-Weg 24\x3cbr\x3e48155 Muenster, Deutschland\x3c/p\x3e'}},
...
"http://sosrest.irceline.be/api/v1/":"irceline","http://www.fluggs.de/sos2/api/v1/":"fluggs","http://sensors.geonovum.nl/sos/api/v1/":"geonovum"},defaultProvider:{serviceID:"srv_738111ed219f738cfc85be0c8d87843c",apiUrl:"http://sensorweb.demo.52north.org/sensorwebclient-webapp-stable/api/v1/"},clusterStations:!0,generalizeData:!0,saveStatus:!1,concentrationMarker:!1,zoom:13,dateformat:"DD.MM.YY HH:mmZ",shortDateformat:"DD.MM.YY",ignoreAfterDuration:moment.duration(1,"y"),timeseriesDataBuffer:moment.duration(2,
...
"pending"===a.state()&&a.reject()},_createIdString:function(a){return null===a?"":a}},Pages={current:function(){return $(".swc-page-current").attr("id")},navigateToPage:function(a){$(".swc-page-current").removeClass("swc-page-current");$(a).addClass("swc-page-current")},navigateToMap:function(){Pages.navigateToPage("#map-page");location.href="#map";Pages.toggleLegend(!1)},navigateToChart:function(){Pages.navigateToPage("#chart-page");location.href="#chart";Pages.togglePhenomenon(!1)},toggleLegend:function(a){a?
($(".legend").toggleClass("active"),$(".legend").hasClass("active")?$('[data-toggle\x3d"legend"]').text("X"):$('[data-toggle\x3d"legend"]').text(_("main.legend"))):($(".legend").removeClass("active"),$('[data-toggle\x3d"legend"]').text(_("main.legend")))},togglePhenomenon:function(a,b){var c=b?b:_("main.allPhenomena");a?($(".phenomena").toggleClass("active"),$(".phenomena").hasClass("active")?$('[data-toggle\x3d"phenomena"]').text("X"):$('[data-toggle\x3d"phenomena"]').text(c)):($(".phenomena").removeClass("active"),
$('[data-toggle\x3d"phenomena"]').text(c))},activateNavButtonsHandler:function(){$('[data-target\x3d"#map"]').click(function(){Pages.navigateToMap()});$('[data-target\x3d"#chart"]').click(function(){Pages.navigateToChart()})},activateToggleButtonsHandler:function(){$("[data-toggle\x3dlegend]").click(function(){Pages.toggleLegend(!0)});$("[data-toggle\x3dphenomena]").click(function(){var a=$(".phenomena-entry").find(".selected").text();Pages.togglePhenomenon(!0,a)})},init:function(){$(document).ready($.proxy(function(){this.activateNavButtonsHandler();
this.activateToggleButtonsHandler()},this));Pages.routeToPage()},routeToPage:function(){var a=window.location.hash;-1!=a.indexOf("?")&&(a=a.substring(a.indexOf("#"),a.indexOf("?")));Pages._routeToPage(a)},_routeToPage:function(a){switch(a){case "#map":Pages.navigateToPage("#map-page");break;case "#chart":Pages.navigateToPage("#chart-page");break;default:Status.hasTimeseries()?$(".swc-main div.swc-page:first").addClass("swc-page-current"):Pages.navigateToMap()}}},Modal={show:function(a,b){$("#modalWindow").html(Template.createHtml(a,
b));$("#modalWindow").modal("show")},hide:function(){$("#modalWindow").modal("hide")},append:function(a,b){$(".modal-body").append(Template.createHtml(a,b))}},EventManager={subscribe:function(a,b){DEBUG&&console.log("Subscribe "+a);$(this).bind(a,b)},unsubscribe:function(a,b){DEBUG&&console.log("Unsubscribe "+a);$(this).unbind(a,b)},publish:function(a,b){DEBUG&&console.log("Publish "+a);$(this).trigger(a,b)}},Status=function(){return{createDefaultValues:function(){this.defaultValues={provider:Settings.defaultProvider,
clusterStations:Settings.clusterStations,generalizeData:Settings.generalizeData,timeseries:{},timespan:Time.isoTimespan(),saveStatus:Settings.saveStatus,concentrationMarker:Settings.concentrationMarker}},init:function(){this.createDefaultValues();this.key=Storage.generateKey("settings");this.load();this.get("saveStatus")||this.reset()},load:function(){var a=Storage.load(this.key);a?this.current=a:(this.current=this.defaultValues,this.save())},save:function(){Storage.saveObject(this.key,this.current)},
reset:function(){this.current=this.defaultValues;this.save();EventManager.publish("resetStatus")},set:function(a,b){this.current[a]=b;this.save()},get:function(a){return this.current[a]?this.current[a]:this.defaultValues[a]},addTimeseries:function(a){this.current.timeseries[a.getInternalId()]=a.persist();this.save()},addTimeseriesById:function(a){var b=a.split("__"),c=null;$.each(Settings.restApiUrls,function(a,e){e==b[1]&&(c=a)});c&&(this.current.timeseries[a]={apiUrl:c,tsId:b[0]},this.save())},
clearTimeseries:function(){this.current.timeseries={};this.save()},removeTimeseries:function(a){delete this.current.timeseries[a.getInternalId()];this.save()},hasTimeseriesWithId:function(a){return!!this.current.timeseries[a]},getTimeseriesWithId:function(a){return this.current.timeseries[a]},getTimeseries:function(){return this.current.timeseries},hasTimeseries:function(){return $.isEmptyObject(this.current.timeseries)?!1:!0}}}(),Button={switchToggleButton:function(a){a=$(a);a.toggleClass("btn-primary");
return a.hasClass("btn-primary")?!0:!1},setToggleButton:function(a,b){var c=$(a);b?c.addClass("btn-primary"):c.removeClass("btn-primary")},setLoadingButton:function(a,b){var c=a.find("span");b?(c.hide(),a.append('\x3cspan class\x3d"glyphicon glyphicon-refresh icon-spin"\x3e\x3c/span\x3e')):(c.show(),a.find(".glyphicon.glyphicon-refresh").remove())},setNewIcon:function(a,b){a.find("span").hide();a.append('\x3cspan class\x3d"glyphicon '+b+'"\x3e\x3c/span\x3e')},removeNewIcon:function(a,b){a.find("span."+
b).remove();a.find("span").show()}};if(navigator.userAgent.match(/IEMobile\/10\.0/)){var msViewportStyle=document.createElement("style");msViewportStyle.appendChild(document.createTextNode("@-ms-viewport{width:auto!important}"));document.querySelector("head").appendChild(msViewportStyle)}
...
removeTS:function(a){a.destroy();Status.removeTimeseries(a);delete this.timeseries[a.getInternalId()];EventManager.publish("timeseries:remove",[a])},removeAllTS:function(){this.timeseries={};EventManager.publish("timeseries:removeAll")},getTimeseriesCollection:function(){return this.timeseries},getMaxTimeExtent:function(){var a,b;$.each(this.timeseries,$.proxy(function(c,d){if(d.getFirstValue()||d.getLastValue()){var e=moment(d.getFirstValue().timestamp),f=moment(d.getLastValue().timestamp);if(!a||
e.isAfter(a))a=e;if(!b||f.isBefore(b))b=f}}));return{from:a,till:b}}},TimeController={currentTimespan:{},timeRangeData:Settings.timeRangeData,init:function(){this.currentTimespan=Status.get("timespan");this.updateTimeExtent();$(document).ready(function(){$("[data-action\x3dbefore]").click($.proxy(function(){TimeController.prevPeriode()},this));$("[data-action\x3dafter]").click($.proxy(function(){TimeController.nextPeriode()},this));$("[data-action\x3dtimeextent]").click($.proxy(function(){Modal.show("time-range-settings",
TimeController.timeRangeData);var a=moment(TimeController.currentTimespan.from),b=moment(TimeController.currentTimespan.till);$("#startPicker").text(a.format(Settings.dateformat));$("#endPicker").text(b.format(Settings.dateformat));$("#startPicker").data("date",a.format("YYYY-MM-DD"));$("#endPicker").data("date",b.format("YYYY-MM-DD"));$("#alertTimeExtent").hide();$("#startPicker").datepicker({position:"above"}).on("changeDate",TimeController.evaluateDate);$("#endPicker").datepicker({position:"above"}).on("changeDate",
TimeController.evaluateDate);$("#confirmTimeExtent").click(function(a){a=moment($("#startPicker").data("date")).startOf("day");var b=moment($("#endPicker").data("date")).endOf("day");TimeController.currentTimespan={from:a,till:b,mode:"range"};TimeController.updateTimeExtent()});$(".preset-btn").click(function(a){a=$(a.currentTarget);TimeController.setPreset(a.data("preset-value"))})},this))});this.setLabel();EventManager.subscribe("timeseries:data:load",$.proxy(this.disableButtons,this));EventManager.subscribe("timeseries:synced",
...
this));EventManager.subscribe("timeseries:removeAll",$.proxy(this.clearChart,this));EventManager.subscribe("timeseries:selected",$.proxy(this.selectTs,this));EventManager.subscribe("timeseries:unselectAll",$.proxy(this.unselectAll,this));EventManager.subscribe("timeseries:hide",$.proxy(this.hideData,this));EventManager.subscribe("timeseries:show",$.proxy(this.showData,this));EventManager.subscribe("navigation:open",$.proxy(this.hideChart,this));EventManager.subscribe("navigation:close",$.proxy(this.showChart,
this));EventManager.subscribe("timeseries:changeStyle",$.proxy(this.changeStyle,this));EventManager.subscribe("timeseries:zeroScaled",$.proxy(this.zeroScaled,this));EventManager.subscribe("timeseries:groupedAxis",$.proxy(this.changeStyle,this));$(window).resize($.proxy(function(){var a=$(document).width()/$(document).height();a!==window.ratio&&(window.ratio=a,this.plotChart())},this));$("[data-action\x3dselection]").hide();$("[data-action\x3dselection]").on("click",$.proxy(function(){EventManager.publish("timeseries:unselectAll");
this.renderChart();$("[data-action\x3dselection]").hide()},this));this.plotChart();$("#placeholder").bind("plotpanEnd",function(a,b){var c=b.getXAxes()[0],d=moment(c.min),c=moment(c.max);TimeController.setFlexibleTimeExtent(d,c)})},hideChart:function(a,b){this.visible=!1;$("#placeholder").hide()},showChart:function(a,b){this.visible=!0;$("#placeholder").show();this.plotChart()},hideData:function(a,b){this.removeData(b);this.plotChart()},showData:function(a,b){var c=TimeSeriesController.getTimeseriesCollection()[b];
this.loadDataFinished(null,c);this.plotChart()},selectTs:function(a,b){this.plot&&($.each(this.plot.getData(),function(a,d){d.id===b&&(d.lines.lineWidth=ChartController.selectedLineWidth,d.bars.lineWidth=ChartController.selectedLineWidth,d.selected=!0,$.each($(".axisTarget"),function(a,b){d.yaxis.n===$(b).data("axis.n")&&$(b).toggleClass("selected")}))}),this.plot.draw(),$.each(this.data,function(a,d){d.id===b&&(d.selected=!0)}))},unselectAll:function(a){this.plot&&($.each(this.plot.getData(),function(a,
c){c.lines.lineWidth=ChartController.commonLineWidth;c.bars.lineWidth=ChartController.commonLineWidth;c.selected=!1}),$.each(this.data,function(a,c){c.selected=!1}),$(".axisTarget").removeClass("selected"),this.plot.draw())},loadDataForChart:function(a,b){if(this.visible){var c=b.getLabel(),c=Template.createHtml("data-loading-entry",{id:b.getInternalId(),color:b.getStyle().getColor(),label:c});$("#loadingDiagram").append(c)}},zeroScaled:function(a,b){$.each(TimeSeriesController.getTimeseriesCollection(),
function(a,d){b.getUom()===d.getUom()&&d.setZeroScaled(b.isZeroScaled())});$.each(this.data,function(a,d){d.uom===b.getUom()&&(d.zeroScaled=b.isZeroScaled())});this.changeStyle(null,b)},changeStyle:function(a,b){this.loadDataFinished(null,b);this.plotChart()},loadDataFinished:function(a,b){$("#loadingDiagram").find("[data-id\x3d"+b.getInternalId()+"]").remove();$.each(b.getRefValues(),$.proxy(function(a,b){var c=this.dataAlreadyIn(b.getId());c&&(c.data=b.getValues())},this));if(b.hasData()){var c=
this.dataAlreadyIn(b.getInternalId());c?this.updateData(c,b):this.data.push(this.createData(b))}else this.removeData(b.getInternalId())},updateData:function(a,b){this.addStyleAndValues(a,b)},createData:function(a){var b={id:a.getInternalId(),uom:a.getUom(),phenomenon:a.getPhenomenonLabel()};this.addStyleAndValues(b,a);return b},addStyleAndValues:function(a,b){var c=b.getStyle();a.color=c.getColor();a.zeroScaled=b.isZeroScaled();a.groupedAxis=b.isGroupedAxis();a.stationLabel=b.getStationLabel();if(c.isBarChart()){a.bars=
{show:!0,barWidth:36E5*c.getIntervalByHours()};a.lines={show:!1};for(var d=[],e=0,f=b.getValues(),g=f[e];g;){for(var m=g[0],h=moment(g[0]).add("hours",c.getIntervalByHours()),k=0;g&&moment(g[0]).isBefore(h);)e++,k+=g[1],g=f[e];d.push([m,k])}a.data=d}else 0<=c.getLineType().indexOf("dotted")&&(a.points={show:!0,fill:!0,fillColor:c.getColor(),radius:c.getWidth()}),0<=c.getLineType().indexOf("solid")?a.lines={show:!0,lineWidth:c.getWidth()}:a.lines={show:!1},a.data=b.getValues()},removeTS:function(a,
...
b.box;if("y"===b.direction){$("\x3cdiv class\x3d'axisTarget' style\x3d'position:absolute; left:"+e.left+"px; top:"+e.top+"px; width:"+e.width+"px; height:"+e.height+"px'\x3e\x3c/div\x3e").data("axis.n",b.n).appendTo(this.plot.getPlaceholder()).click($.proxy(function(a){var c=$(a.currentTarget),e=!1;$.each($(".axisTarget"),function(a,b){b=$(b);if(c.data("axis.n")===b.data("axis.n"))return e=b.hasClass("selected"),!1});EventManager.publish("timeseries:unselectAll");$.each(this.plot.getData(),function(a,
f){if(f.yaxis.n===b.n&&!e&&(EventManager.publish("timeseries:selected",f.id),c.addClass("selected"),!f.groupedAxis))return!1});this.plot.draw()},this));var f=$("\x3cdiv class\x3d'axisLabel yaxisLabel' style\x3dleft:"+e.left+"px;\x3e\x3c/div\x3e").text(b.options.uom).appendTo("#placeholder");$.each(b.options.tsColors,function(a,b){$("\x3cspan\x3e").html("\x26nbsp;\x26#x25CF;").css("color",b).addClass("labelColorMarker").appendTo(f)});f.css("margin-left",-(f.width()-f.height())/2-3)}}},this));var b=
!1;$.each(this.plot.getData(),function(a,d){d.selected&&(d.lines.lineWidth=ChartController.selectedLineWidth,d.bars.lineWidth=ChartController.selectedLineWidth,b=!0,$.each($(".axisTarget"),function(){if($(this).data("axis.n")===d.yaxis.n&&!$(this).hasClass("selected"))return $(this).addClass("selected"),!1}))});b&&this.plot.draw()}}},updateXAxis:function(){this.options.xaxis.min=TimeController.getCurrentStartAsMillis();this.options.xaxis.max=TimeController.getCurrentEndAsMillis()},createYAxis:function(){var a=
{};$.each(this.data,function(b,d){void 0===d.groupedAxis||d.groupedAxis?(a.hasOwnProperty(d.uom)?a[d.uom].tsColors.push(d.color):a[d.uom]={id:++Object.keys(a).length,uom:d.uom,tsColors:[d.color],zeroScaled:d.zeroScaled},d.yaxis=a[d.uom].id):(a[d.id]={id:++Object.keys(a).length,uom:d.uom+" @ "+d.stationLabel,tsColors:[d.color],zeroScaled:d.zeroScaled},d.yaxis=a[d.id].id)});var b=[];$.each(a,function(a,d){b.splice(d.id-1,0,{uom:d.uom,tsColors:d.tsColors,min:d.zeroScaled?0:null})});return b},dataAlreadyIn:function(a){var b=
null,b=$.map(this.data,function(b){if(a===b.id)return b});return b[0]},removeData:function(a){var b=-1;$.each(this.data,function(c,d){a==d.id&&(b=c)});0<=b&&this.data.splice(b,1)}},LegendController={init:function(){EventManager.subscribe("timeseries:add",$.proxy(this.addTS,this));EventManager.subscribe("timeseries:remove",$.proxy(this.removeTS,this));EventManager.subscribe("timeseries:removeAll",$.proxy(this.removeAll,this));EventManager.subscribe("timeseries:selected",$.proxy(this.selectTS,this));
EventManager.subscribe("timeseries:unselectAll",$.proxy(this.deselectAllTS,this));EventManager.subscribe("timeseries:data:loadfinished",$.proxy(this.checkNoData,this));EventManager.subscribe("timeseries:changeStyle",$.proxy(this.changeStyle,this));EventManager.subscribe("timeseries:synced",$.proxy(this.syncedTS,this))},addTS:function(a,b){var c=this.createEntry(b);this.removeEntry(b.getInternalId());$(".legend-entry").append(c);this.addClickEvents(b)},addClickEvents:function(a){$("[data-id\x3d"+a.getInternalId()+
"] .firstLastEntry").on("click",function(a){a.stopPropagation();var c=$(a.currentTarget).data("firsttime");c&&EventManager.publish("time:start:change",c);(c=$(a.currentTarget).data("lasttime"))&&EventManager.publish("time:end:change",c)});$("[data-id\x3d"+a.getInternalId()+"] .legendItemheader").click($.proxy(function(b){$("[data-id\x3d"+a.getInternalId()+"]").hasClass("selected")?EventManager.publish("timeseries:unselectAll"):(EventManager.publish("timeseries:unselectAll"),EventManager.publish("timeseries:selected",
a.getInternalId()))},this));$("[data-id\x3d"+a.getInternalId()+"] .hideDiagram").click($.proxy(function(b){target=$(b.currentTarget);target.hasClass("glyphicon-eye-close")?EventManager.publish("timeseries:hide",a.getInternalId()):EventManager.publish("timeseries:show",a.getInternalId());target.toggleClass("glyphicon-eye-close");target.toggleClass("glyphicon-eye-open")},this));$("[data-id\x3d"+a.getInternalId()+"] .delete").click($.proxy(function(b){TimeSeriesController.removeTS(a)},this));$("[data-id\x3d"+
a.getInternalId()+"] .inMap").click($.proxy(function(b){EventManager.publish("timeseries:showInMap",a)},this));$("[data-id\x3d"+a.getInternalId()+"] .changeStyle").click($.proxy(function(b){StyleChangeController.open(a)},this));$("[data-id\x3d"+a.getInternalId()+"] .showInfo").click($.proxy(function(b){$("[data-id\x3d"+a.getInternalId()+"]").find(".collapseLegendEntry").toggle()},this));$("[data-id\x3d"+a.getInternalId()+"] .refEntry").on("click",function(b){b=$(b.currentTarget);b.toggleClass("selected");
var c;c=b.hasClass("selected")?"timeseries:add:referenceValue":"timeseries:remove:referenceValue";EventManager.publish(c,{tsId:a.getInternalId(),refId:b.data("refid")})})},checkNoData:function(a,b){var c=$(".legend-entry").find("[data-id\x3d"+b.getInternalId()+"] .noDataWarning");b.hasData()?c.hide():c.show()},selectTS:function(a,b){$(".legend-entry").find("[data-id\x3d"+b+"]").addClass("selected")},changeStyle:function(a,b){this.updateEntry(b)},deselectAllTS:function(a){$(".legend-entry").find(".legendItem.selected").removeClass("selected")},
removeTS:function(a,b){this.removeEntry(b.getInternalId())},removeAll:function(a){$(".legend-entry").empty()},removeEntry:function(a){$(".legend-entry").find("[data-id\x3d"+a+"]").remove()},updateEntry:function(a){var b=this.createEntry(a);$(b).replaceAll(".legend-entry [data-id\x3d"+a.getInternalId()+"]");this.addClickEvents(a)},syncedTS:function(){var a=!0;$.each(TimeSeriesController.timeseries,function(b,c){c.hasData()&&(a=!1)});a&&Pages.toggleLegend(!0)},createEntry:function(a){var b=a.getFirstValue(),
c=a.getLastValue(),d=$.map(a.getRefValues(),function(a,b){return{id:a.getId(),label:a.getLabel(),color:a.getColor()}});return Template.createHtml("legend-entry",{id:a.getInternalId(),color:a.getStyle().getColor(),synced:a.isSynced(),uom:this.createText(a.getUom),phenomenon:this.createText(a.getPhenomenonLabel()),procedure:this.createText(a.getProcedureLabel()),station:this.createText(a.getStationLabel()),category:this.createText(a.getCategoryLabel()),firstValueTime:b?b.timestamp:"",firstValueTimeFormatted:b?
...
function(c){c=$(c.target).data("color");b.getColor()!=c&&(b.setColor(c),EventManager.publish("timeseries:changeStyle",a))});$(".intervalButton").on("click",function(c){c=$(c.target).data("interval");b.getIntervalByHours()!=c&&(b.setIntervalByHours(c),EventManager.publish("timeseries:changeStyle",a))});$(".zeroScaled").on("click",function(b){b=Button.switchToggleButton(b.target);a.setZeroScaled(b);EventManager.publish("timeseries:zeroScaled",a)});$(".groupedAxis").on("click",function(b){b=Button.switchToggleButton(b.target);
a.setGroupedAxis(b);EventManager.publish("timeseries:groupedAxis",a)})}},TableController={isVisible:!1,pageStart:0,pageSize:Settings.pagesize||10,init:function(){this.tableButton=$('[data-action\x3d"dataTable"]');this.tableView=$("#tableView");this.tableButton.show();this.tableButton.on("click",$.proxy(function(a){a=$(a.currentTarget);var b=$('[data-toggle\x3d"legend"]');!1==this.isVisible?(this.isVisible=!0,this.tableView.show(),Button.setNewIcon(a,"glyphicon-stats"),b.hide(),EventManager.publish("navigation:open",
"table")):(this.isVisible=!1,this.tableView.hide(),b.show(),Button.removeNewIcon(a,"glyphicon-stats"),EventManager.publish("navigation:close","table"))},this));EventManager.subscribe("navigation:open",$.proxy(this.createTable,this));EventManager.subscribe("timeseries:synced",$.proxy(this.createTable,this));EventManager.subscribe("timeseries:remove",$.proxy(this.createTable,this));EventManager.subscribe("timeseries:changeStyle",$.proxy(this.updateTable,this))},createTable:function(){this.isVisible&&
(this.tableView.empty(),this.sortingFunc=null,this.pageStart=0,this.createHtmlTableHeader(),this.tableView.append(this.htmltable),this.updateTable(),this.createHeaderClickHandler())},updateTable:function(){if(this.isVisible){var a=this.createValueArray();this.sortingFunc&&a.sort(this.sortingFunc);if(0<a.length){var b=this.createColorArray();this.createHtmlTable(a,b)}this.createPaging(a.length,this.pageSize,this.pageStart);this.createPagingClickHandler(a.length)}},createHeaderClickHandler:function(){$(".table th").on("click",
$.proxy(function(a){a=$(a.currentTarget);var b=a.data("index");a.hasClass("sortedUp")?(a.removeClass("sortedUp").addClass("sortedDown"),this.changeSortLabel(a,!1),this.sortingFunc=this.downsort(b)):(a.hasClass("sortedDown")?a.removeClass("sortedDown").addClass("sortedUp"):($(".table th").removeClass("sortedUp").removeClass("sortedDown"),a.addClass("sortedUp")),this.changeSortLabel(a,!0),this.sortingFunc=this.upsort(b));this.updateTable()},this))},changeSortLabel:function(a,b){$("#sorting").remove();
var c=$("\x3cspan\x3e").attr("id","sorting");b?c.html("\x26nbsp;\x26#x25BE;"):c.html("\x26nbsp;\x26#x25B4;");a.append(c)},createPagingClickHandler:function(a){$(".pagination li a").on("click",$.proxy(function(b){b=$(b.target).data("start");"undefined"!==typeof b&&0<=b&&b<=a&&(this.pageStart=b,this.updateTable())},this))},createPaging:function(a,b,c){this.tableView.find("div.paging").remove();var d=$('\x3cdiv class\x3d"paging"\x3e\x3c/div\x3e'),e=$('\x3cul class\x3d"pagination"\x3e\x3c/ul\x3e');e.append(this.pageButton("\x26laquo;",
0));e.append(this.pageButton("\x26lsaquo;",c-b));e.append(this.pageButton(Math.ceil((c+1)/b)+"/"+Math.ceil(a/b)));e.append(this.pageButton("\x26rsaquo;",c+b));e.append(this.pageButton("\x26raquo;",Math.floor(a/b)*b));d.append(e);this.tableView.append(d)},pageButton:function(a,b){var c=$("\x3cli\x3e\x3c/li\x3e"),d=$("\x3ca\x3e"+a+"\x3c/a\x3e");d.data("start",b);c.append(d);return c},createColorArray:function(){var a=[];$.each(TimeSeriesController.getTimeseriesCollection(),function(b,c){a.push(c.getStyle().getColor())});
return a},createValueArray:function(){var a=[];$.each(TimeSeriesController.getTimeseriesCollection(),function(b,c){var d=c.getValues(),e=null!=a[0]&&0<a[0].length?a[0].length:0,f=0;$.each(d,function(b,c){var d=c[0],k=c[1];if(0==e)a.push([d,k]);else{for(;null!=a[f]&&a[f][0]<d;)a[f][e]="-",f++;if(null!=a[f]&&a[f][0]==d)a[f][e]=k;else{var l=[];l.push(d);for(d=1;d<e;d++)l.push("-");l.push(k);a.splice(f,0,l)}f++}})});return a},upsort:function(a){return function(b,c){return isNaN(b[a])&&isNaN(c[a])?0:isNaN(b[a])?
-1:isNaN(c[a])?1:b[a]-c[a]}},downsort:function(a){return function(b,c){return isNaN(b[a])&&isNaN(c[a])?0:isNaN(b[a])?1:isNaN(c[a])?-1:c[a]-b[a]}},createHtmlTableHeader:function(){this.htmltable=$("\x3ctable\x3e\x3c/table\x3e").addClass("table").addClass("table-condensed");var a=$("\x3cthead\x3e\x3c/thead\x3e"),b=$("\x3ctr\x3e\x3c/tr\x3e");b.append($("\x3cth\x3e\x3c/th\x3e").data("index",0).text(_("table.time")));var c=1;$.each(TimeSeriesController.getTimeseriesCollection(),function(a,e){var f=$("\x3cdiv\x3e\x3c/div\x3e").text(e.getStationLabel()),
g=$("\x3cspan\x3e\x3c/span\x3e").text(e.getPhenomenonLabel()+" ("+e.getUom()+")"),m=$("\x3cdiv\x3e\x3c/div\x3e").text(e.getCategoryLabel());b.append($("\x3cth\x3e\x3c/th\x3e").data("index",c++).append(f).append(g).append(m))});this.htmltable.append(a.append(b))},createHtmlTable:function(a,b){this.htmltable.find("tbody tr").remove();$.each(a,$.proxy(function(a,d){if(!(a<this.pageStart||a>=this.pageStart+this.pageSize)){var e=$("\x3ctr\x3e\x3c/tr\x3e");$.each(d,function(a,c){0==a?e.append($("\x3ctd\x3e\x3c/td\x3e").text(moment(c).format(Settings.dateformat))):
e.append($("\x3ctd\x3e\x3c/td\x3e").css("color",b[a-1]).append($("\x3cb\x3e\x3c/b\x3e").text(c)))});this.htmltable.append(e)}},this));return this.htmltable}},ExportController={init:function(){var a=this.msieversion();(!a||9<a)&&EventManager.subscribe("timeseries:add",$.proxy(this.loadTimeseries,this))},loadTimeseries:function(a,b){tsId=b.getInternalId();var c=$('\x3cdiv class\x3d"additionalLegendEntry"\x3e\x3cspan class\x3d"glyphicon glyphicon-download"\x3e\x3c/span\x3e\x3cspan\x3e '+_("export.label")+
"\x3c/span\x3e\x3c/div\x3e");$('.legendItem[data-id\x3d"'+tsId+'"]').find(".collapseLegendEntry").append(c);c.on("click",$.proxy(function(){this.createCSVforTS(b)},this))},createCSVforTS:function(a){var b="Sensor Station;Sensor Phenomenon;Date;Value\n";$.each(a.getValues(),function(c,d){b+=a.getStationLabel()+";";b+=a.getPhenomenonLabel()+" ("+a.getUom()+");";b+=moment(d[0]).format()+";";b+=d[1];b+="\n"});this.triggerDownload(b,a.getLabel())},triggerDownload:function(a,b){var c=b;c||(c="export.csv");
-1==c.indexOf(".csv")&&(c+=".csv");if(navigator.msSaveBlob){var d=new Blob(["﻿"+a],{type:"text/csv;charset\x3dutf-8;",encoding:"utf-8"});navigator.msSaveBlob(d,c)}else d=document.createElement("a"),d.href="data:text/csv;base64,"+btoa(a),d.target="_blank",d.download=c,document.body.appendChild(d),d.click()},msieversion:function(){var a=window.navigator.userAgent,b=a.indexOf("MSIE ");if(0<b)return parseInt(a.substring(b+5,a.indexOf(".",b)))}},GuidedTourController=function(){var a=function(b,c){!c.hasData()&&
c.getLastValue().timestamp?EventManager.publish("time:end:change",c.getLastValue().timestamp):(EventManager.unsubscribe("timeseries:data:loadfinished",a),this.showNext())},b=function(){EventManager.unsubscribe("map:stationLoaded",b);setTimeout($.proxy(function(){this.showNext()},this),200)},c=[{anchor:".navbar-header.chart",title:_("guide.step1.header"),text:_("guide.step1.text"),initStep:function(){Pages.navigateToChart()}},{anchor:'[data-target\x3d"#map"]',title:_("guide.step2.header"),text:_("guide.step2.text"),
arrow:!0,initStep:function(){Pages.navigateToChart()}},{anchor:".navbar-header.map",title:_("guide.step3.header"),text:_("guide.step3.text"),initStep:function(){Pages.navigateToMap()}},{anchor:'[data-action\x3d"provider"]',title:_("guide.step4.header"),text:_("guide.step4.text"),arrow:!0,initStep:function(){}},{anchor:'[data-action\x3d"locate"]',title:_("guide.step5.header"),text:_("guide.step5.text"),arrow:!0,initStep:function(){}},{anchor:'[data-action\x3d"listSelection"]',title:_("guide.step6.header"),
text:_("guide.step6.text"),arrow:!0,initStep:function(){}},{anchor:".navbar-header.map",title:_("guide.step7.header"),text:_("guide.step7.text"),next:!1,initStep:function(a){EventManager.subscribe("map:stationLoaded",$.proxy(b,a))}},{anchor:".tsItem input",title:_("guide.step8.header"),text:_("guide.step8.text"),previous:!1,next:!1,arrow:!0,initStep:function(b){EventManager.subscribe("timeseries:data:loadfinished",$.proxy(a,b))}},{anchor:".legend-entry",title:_("guide.step9.header"),text:_("guide.step9.text"),
arrow:!0,previous:!1,initStep:function(){Pages.toggleLegend(!0)}},{anchor:".navbar-header.chart",title:_("guide.step10.header"),text:_("guide.step10.text"),initStep:function(){Pages.toggleLegend(!1)}},{anchor:".btn-group.timeSelection",title:_("guide.step11.header"),text:_("guide.step11.text"),arrow:!0,initStep:function(){}},{anchor:'[data-action\x3d"dataTable"]',title:_("guide.step12.header"),text:_("guide.step12.text"),arrow:!0,initStep:function(){}},{anchor:'[data-target\x3d"#favorites"]',title:_("guide.step13.header"),
text:_("guide.step13.text"),arrow:!0,initStep:function(){}},{anchor:".navbar-header.chart",title:_("guide.step14.header"),text:_("guide.step14.text"),initStep:function(){}}];return{init:function(){$(document).ready(function(){$('[data-target\x3d"#tour"]').click(function(){GuidedTourController.start()})});"true"===Permalink.getUrlParameter("tour")&&GuidedTourController.start()},start:function(){this.closeLast();this.show(1);Status.reset()},showNext:function(){this.closeLast();this.show(this.idx+1)},
closeLast:function(){this.gtWindow&&this.gtWindow.popover("destroy")},show:function(a){this.idx=a;var b=c[a-1];b.initStep(this);this.gtWindow=$(b.anchor+":first").popover({html:!0,template:b.arrow?'\x3cdiv class\x3d"popover guidedtour"\x3e\x3cdiv class\x3d"arrow"\x3e\x3c/div\x3e\x3cdiv class\x3d"popover-content"\x3e\x3c/div\x3e\x3c/div\x3e':'\x3cdiv class\x3d"popover guidedtour"\x3e\x3cdiv class\x3d"popover-content"\x3e\x3c/div\x3e\x3c/div\x3e',trigger:"manual",content:Template.createHtml("guidedtour",
{title:b.title,text:b.text,previous:1<=a-1&&!1!=b.previous?a-1:null,step:a,next:a+1<=c.length&&!1!=b.next?a+1:null,steps:c.length}),placement:"auto"});$(b.anchor).popover("show");$(".paging.guidedtour li a").on("click",$.proxy(function(a){a=parseInt(a.currentTarget.dataset.step);isNaN(a)||(this.closeLast(),this.show(a))},this));$(".guidedtour .close").on("click",$.proxy(function(){this.closeLast()},this));this.gtWindow.on("hidden.bs.popover",$.proxy(function(){this.closeLast()},this))}}}(),FavoriteController=
{favorites:{},groupIdx:0,favoriteGroups:{},init:function(){this.key=Storage.generateKey("favorites");this.favoriteButton=$(".favoriteButton");this.favoriteButton.show();this.favoriteButton.on("click",$.proxy(function(a){var b=Pages.current();this.showFavoritesView();$("#favoriteButton").on("click",$.proxy(function(a){Pages.navigateToPage("#"+b)}))},this));this.createFavoritesListView();this.activateImportExportHandlers();EventManager.subscribe("timeseries:add",$.proxy(this.addLegendStar,this));EventManager.subscribe("timeseries:changeStyle",
$.proxy(this.addLegendStar,this));EventManager.subscribe("map:stationLoaded",$.proxy(this.addStationStar,this));EventManager.subscribe("settings:opened",$.proxy(function(){var a=$(Template.createHtml("favorite-settings-button"));$("#accordionSettings .permalink .panel-body").append(a);a.on("click",$.proxy(function(){if(0<Object.keys(TimeSeriesController.timeseries).length)if(this.isInFavoriteGroup(TimeSeriesController.timeseries))NotifyController.notify(_("favorite.group.exists"));else{var a=this.addFavoriteGroup(TimeSeriesController.timeseries);
this.saveFavorites();NotifyController.notify(_("favorite.group.add").replace("{0}",a))}else NotifyController.notify(_("favorite.group.noTimeseries"))},this))},this));this.loadFavorites()},navigateToFavoritesView:function(){Pages.navigateToPage("#favorite-page");Pages.toggleLegend(!1);Pages.togglePhenomenon(!1)},clearFavoritesView:function(){$("#favorites-list").empty()},updateFavoritesView:function(){this.clearFavoritesView();$.each(this.favorites,$.proxy(function(a,b){this.drawFavorite(b)},this));
$.each(this.favoriteGroups,$.proxy(function(a,b){this.drawFavoriteGroup(b,a)},this))},drawFavorite:function(a){var b=a.timeseries,c=b.getLastValue();a=Template.createHtml("favorite-entry",{id:b.getInternalId(),label:a.label,provider:b.getServiceLabel(),lastValueTimeFormatted:c?moment(c.timestamp).format(Settings.dateformat):"",lastValue:c.value||"",uom:b.getUom()||""});$("#favorites-list").append(a);this.addFavoriteClickEvent(b.getInternalId())},drawFavoriteGroup:function(a,b){var c=Template.createHtml("favorite-group-entry",
{id:b,label:a.label,collection:$.map(a.collection,function(a){var b=a.getLastValue();return{label:a.getLabel(),lastValueTimeFormatted:b?moment(b.timestamp).format(Settings.dateformat):"",lastValue:b.value||"",uom:a.getUom()||""}})});$("#favorites-list").append(c);this.addGroupClickEvents(b)},showFavoritesView:function(){this.navigateToFavoritesView()},addFavoriteClickEvent:function(a){this.addClickEvents(a,"single-id","delete",$.proxy(function(b){this.removeFavorite(a);this.saveFavorites()},this));
this.addClickEvents(a,"single-id","edit",$.proxy(function(b){this.openEditWindow(this.favorites[a])},this));this.addClickEvents(a,"single-id","addToDiagram",$.proxy(function(b){b=this.favorites[a];Pages.navigateToChart();TimeSeriesController.addTS(b.timeseries)},this))},addGroupClickEvents:function(a){this.addClickEvents(a,"group-id","delete",$.proxy(function(b){delete this.favoriteGroups[a];$("[data-group-id\x3d"+a+"]").remove();this.saveFavorites()},this));this.addClickEvents(a,"group-id","edit",
$.proxy(function(b){this.openEditWindow(this.favoriteGroups[a])},this));this.addClickEvents(a,"group-id","addToDiagram",$.proxy(function(b){b=this.favoriteGroups[a];Pages.navigateToChart();$.each(b.collection,function(a,b){TimeSeriesController.addTS(b)})},this))},addClickEvents:function(a,b,c,d){$("[data-"+b+"\x3d"+a+"] ."+c).on("click",d)},openEditWindow:function(a){Modal.show("favorite-edit",{label:a.label});$("#confirmFavoritEdit").on("click",$.proxy(function(b){a.label=$("#favoriteLabel")[0].value;
this.saveFavorites();this.updateFavoritesView()},this))},createFavoritesListView:function(){var a=Template.createHtml("favorites-main");$(".swc-main").append(a);Pages.activateNavButtonsHandler()},activateImportExportHandlers:function(){var a=$("#favorites-file-import"),b=$("#favorites-file-export");a.change($.proxy(this.importFavorites,this));b.click($.proxy(this.exportFavorites,this))},createEmptyStar:function(){return $('\x3cspan class\x3d"glyphicon glyphicon-star-empty star"\x3e\x3c/span\x3e')},
...
a));this.addStationStar()},this)):(c=this.createEmptyStar(),d=$.proxy(function(a){a.stopPropagation();Rest.timeseries(b.dataset.id,Status.get("provider").apiUrl).done($.proxy(function(a){a=this.addFavorite(a);NotifyController.notify(_("favorite.single.add").replace("{0}",a));this.addStationStar()},this))},this));$(b).find(".checkbox label").after(c);c.on("click",d)},this))},addFavorite:function(a,b){b=this.addFavoriteToList(a,b);this.addLegendStar(null,a);return b},removeFavorite:function(a){a instanceof
...
b){b=b||"Status "+this.groupIdx;this.favoriteGroups[this.groupIdx]={label:b,collection:$.map(a,function(a,b){return a})};this.saveFavorites();this.drawFavoriteGroup(this.favoriteGroups[this.groupIdx],this.groupIdx);this.groupIdx++;return b},isInFavoriteGroup:function(a){var b=!1;$.each(this.favoriteGroups,function(c,d){var e=!0;d.collection.length===Object.keys(a).length?$.each(d.collection,function(b,c){var d=!1;$.each(a,function(a){a===c.getInternalId()&&(d=!0)});d||(e=!1)}):e=!1;e&&(b=!0)});return b},
saveFavorites:function(){var a=this.serializeFavorites();Storage.saveObject(this.key,a)},loadFavorites:function(){var a=Storage.load(this.key);this.unserializeFavorites(a)},unserializeFavorites:function(a){a&&($.each(a.single,$.proxy(function(a,c){var d=c.timeseries;if(this.isSupported(d)){var e=this;Rest.timeseries(d.tsId,d.apiUrl).done(function(a){e.addFavorite(a,c.label)})}else NotifyController.notify(_("favorite.single.notSupported").replace("{0}",c.label))},this)),$.each(a.groups,$.proxy(function(a,
c){var d=c.label,e=$.map(c.collection,$.proxy(function(a){if(this.isSupported(a))return Rest.timeseries(a.tsId,a.apiUrl);NotifyController.notify(_("favorite.group.notSupported").replace("{0}",d))},this));$.when.apply(null,e).done($.proxy(function(){debugger;this.addFavoriteGroup(arguments,d)},this))},this)))},isSupported:function(a){var b=!1;$.each(Settings.restApiUrls,function(c,d){a.apiUrl===c&&(b=!0)});return b},serializeFavorites:function(){return{single:$.map(this.favorites,function(a,b){return{label:a.label,
timeseries:a.timeseries.persist()}}),groups:$.map(this.favoriteGroups,function(a,b){return{label:a.label,collection:$.map(a.collection,function(a,b){return a.persist()})}})}},exportFavorites:function(){if(this.isFileAPISupported()){var a=JSON.stringify(this.serializeFavorites());if(window.navigator.msSaveBlob)a=new Blob([a],{type:"application/json;charset\x3dutf-8;"}),window.navigator.msSaveBlob(a,"favorites.json");else{var b=document.createElement("a");b.href="data:application/json,"+encodeURI(a);
b.target="_blank";b.download="favorites.json";document.body.appendChild(b);b.click()}}else Inform.warn("The File APIs are not fully supported in this browser.")},importFavorites:function(a){if(this.isFileAPISupported()){var b=!0;this.hasFavorites()&&(b=confirm("Override favorites?"));if(b&&(this.favorites={},this.clearFavoritesView(),(a=a.target.files)&&0<a.length)){b=new FileReader;b.readAsText(a[0]);b.onerror=function(){Inform.error("Could not read file!")};var c=this;b.onload=function(a){a=JSON.parse(a.target.result);
c.unserializeFavorites(a);c.saveFavorites()}}}else Inform.warn("The File APIs are not fully supported in this browser.")},isFileAPISupported:function(){return window.File&&window.FileReader&&window.Blob}},NotifyController={options:{position:"bottom-left",fade_in_speed:"medium",fade_out_speed:2E3,time:4E3},init:function(){$.extend($.gritter.options,this.options)},notify:function(a){$.gritter.add({text:a})}};